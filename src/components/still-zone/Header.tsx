...
import { Menu, BarChart3, User, Settings, LogOut, Home, CreditCard } from 'lucide-react';
...
export default function StillZoneHeader() {
    ...
    const navItems = [
        ...
        { label: 'Settings', icon: Settings, href: '/still-zone/settings', color: 'text-slate-600 dark:text-slate-400', bg: 'bg-slate-100 dark:bg-slate-800' },
    ];
